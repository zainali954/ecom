...
export function getVerifyEmailHtml(verifyUrl: string): string {
  const content = `
    ...
    ${emailText("Thanks for creating a ShopRehan account! Click the button below to verify your email address and get started.")}
  ...
  return emailLayout(content, "Verify your email to activate your ShopRehan account");
}
